...
보완 과정을 통해 알게 된 점은 하드웨어 자체의 문제가 있을 수 있으니 꼭 초반에 여러 개로 테스트를 해보면서 성능 차이가 있는지 알고 있어야 한다는 점입니다. 그리고 IR 수신기에 다양한 회사의 리모컨을 작동시킬 수 있고, 기본 제공된 아두이노 리모컨보다 더 잘 작동하는 것을 알 수 있었습니다. <br>
